...
DynamicLabelDetector::DynamicLabelDetector()
{
...
void DynamicLabelDetector::FindLabels(cv::Mat &image,
...
void DynamicLabelDetector::reconfigureCb(label_detector::DetectorConfig &config,
																				 uint32_t level)
{
